...
#
# This script is used to control an Ender 3 v2 for probing of a tactile sensor for data acquisition.

# BELOW IS SOURCED FROM https://github.com/XDGFX/gcode-cmm/blob/master/cmm.py
#!/usr/bin/env python3
